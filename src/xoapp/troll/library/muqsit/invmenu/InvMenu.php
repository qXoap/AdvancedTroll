...
namespace xoapp\troll\library\muqsit\invmenu;
...
use xoapp\troll\library\muqsit\invmenu\inventory\SharedInvMenuSynchronizer;
use xoapp\troll\library\muqsit\invmenu\session\InvMenuInfo;
use xoapp\troll\library\muqsit\invmenu\session\network\PlayerNetwork;
use xoapp\troll\library\muqsit\invmenu\transaction\DeterministicInvMenuTransaction;
...
use xoapp\troll\library\muqsit\invmenu\transaction\SimpleInvMenuTransaction;
...
class InvMenu implements InvMenuTypeIds{
	 ...
	 * @return Closure(InvMenuTransaction) : \xoapp\troll\library\muqsit\invmenu\transaction\InvMenuTransactionResult
	 */
	...
	/**
	 * @return (Closure(InvMenuTransaction) : \xoapp\troll\library\muqsit\invmenu\transaction\InvMenuTransactionResult)|null
	 */
	...
	/**
	 * @param (Closure(\xoapp\troll\library\muqsit\invmenu\transaction\InvMenuTransaction) : \xoapp\troll\library\muqsit\invmenu\transaction\InvMenuTransactionResult)|null $listener
	 * @return self
	 */
